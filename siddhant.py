...
from Config import STRING, SUDO, BIO_MESSAGE, ALIVE_NAME, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, STRING11, STRING12 , STRING13 , STRING14 , STRING15 ,STRING16 , STRING17 , STRING18 , STRING19 , STRING20 
import asyncio
...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await hdk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await hdk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            
            await hdk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            await sdk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await sdk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await sdk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await adk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await adk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            await adk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await bdk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await bdk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            await bdk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await cdk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await cdk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await cdk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH")) #DON'T DELETE THIS PLZ
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await ddk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            await ddk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await edk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await edk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await edk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await vkk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await vkk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await vkk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await kkk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await kkk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await kkk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await lkk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await lkk(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await lkk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            await mkk(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await mkk(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await mkk(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await sid(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await sid(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            await sid(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await shy(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await shy(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await shy(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await aan(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await aan(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await aan(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await ake(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await ake(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            await ake(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            await eel(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await eel(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await eel(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@LEGACY_LEAVERS_SPAM_BOT"))
            await khu(functions.channels.JoinChannelRequest(channel="@LOVE_FOREVER_WALA"))
            await khu(functions.channels.JoinChannelRequest(channel="@D3VIL_TECH"))
            await khu(functions.channels.JoinChannelRequest(channel="@TEAM_FIGHTERS_OWNER"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
︎ ☠︎︎☠︎︎☠︎︎  𝐋𝐄𝐆𝐀𝐂𝐘   𝐋𝐄𝐀𝐕𝐄𝐑𝐒   𝐒𝐏𝐀𝐌 𝐁𝐎𝐓   ☠︎︎☠︎︎☠︎︎

💥𝐂𝐑𝐄𝐀𝐓𝐄𝐃  𝐁𝐘 𝐒𝐈𝐃𝐃𝐇𝐀𝐑𝐓𝐇 & 𝐒𝐈𝐃𝐃𝐇𝐀𝐍𝐓 💥"""

print(text)
print("")
print("𝐁𝐎𝐓 𝐈𝐒 𝐑𝐄𝐀𝐃𝐘 𝐓𝐎 𝐅𝐈𝐆𝐇𝐓 💣💣")
